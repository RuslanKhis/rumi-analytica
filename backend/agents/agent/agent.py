...
from .tools import call_web_search_agent, call_db_agent, call_data_science_agent, call_document_agent, call_econometrics_agent
...
root_agent = Agent(
    ...
    tools=[call_web_search_agent, load_artifacts, call_db_agent, call_data_science_agent, call_document_agent, call_econometrics_agent],
